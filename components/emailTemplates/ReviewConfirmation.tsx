export const ReviewConfirmationEmail = ({ name }: { name: string }) => {
  return (
    <div className="p-8 min-h-screen flex justify-center items-center bg-gray-100">
      <div className="max-w-md mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="p-6 sm:p-8">
          <h2 className="text-2xl font-extrabold text-black">Hello, {name}</h2>
          <p className="mt-4 text-lg text-gray-800">
            Thank you for submitting your review!
          </p>
          <p className="mt-2 text-gray-600">
            Your review has been successfully stored. We&apos;re reviewing it
            and it will be published soon on our platform.
          </p>
          <div className="mt-6">
          ...
          <footer className="mt-8 border-t pt-4 text-sm text-gray-600">
            <p>
              If you did not submit this review, please{" "}
              <a
